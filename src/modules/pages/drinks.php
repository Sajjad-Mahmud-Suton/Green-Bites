...
<section id="drinksSection" class="py-3">
  <div class="container">
    ...
    <div class="menu-page-header text-center mb-4">
      <h2 class="menu-page-title"><i class="bi bi-cup-straw me-2"></i>Drinks</h2>
      <div class="heading-underline mx-auto"></div>
      <p class="text-muted mt-2">Refreshing beverages to quench your thirst</p>
    </div>
    
    <!-- MENU CARDS - Dynamically loaded from database -->
    <div class="row row-cols-1 row-cols-md-3 row-cols-lg-5 g-4 mb-4">
      <?php
      // Fetch drinks items (category_id = 1)
      ...
      if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo '<div class="col-12"><div class="alert alert-info text-center">No drinks available at the moment. Please check back later!</div></div>';
      }
