 ...
 * ║  FILE: user.js                                                            ║
 * ║  PATH: /js/user.js                                                        ║
 * ║  DESCRIPTION: User-side functionality for Green Bites canteen            ║
 * ╠═══════════════════════════════════════════════════════════════════════════╣
 * ║  SECTIONS:                                                                ║
 * ║    1. Imports & Firebase Dependencies                                     ║
 * ║    2. Global Variables & DOM Elements                                     ║
 * ║    3. Menu Loading Functions                                              ║
 * ║    4. Order Modal & Form Handlers                                         ║
 * ║    5. Table Status Functions                                              ║
 * ║    6. Order Tracking (Real-time)                                          ║
 * ║    7. Complaint Submission                                                ║
 * ║    8. Daily Specials Slider                                               ║
 * ║    9. Initialization                                                      ║
 * ╠═══════════════════════════════════════════════════════════════════════════╣
 * ║  DEPENDENCIES:                                                            ║
 * ║    - firebase-config.js (db, storage)                                     ║
